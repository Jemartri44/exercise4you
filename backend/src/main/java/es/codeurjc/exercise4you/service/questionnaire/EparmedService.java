...
public class EparmedService {
    ...
    public QuestionnairesInfo getEparmedSessionsInfo(Integer id) {
        ...
        String description = "<p>El <b>ePARmed-X</b> está diseñado para ser utilizado por <b>profesionales de la salud</b> en la evaluación de sus pacientes antes de la participación en <b>actividades físicas o programas de ejercicio</b>. A diferencia de herramientas más básicas como el <b>PAR-Q+</b>, que están pensadas para ser <b>autoadministradas</b>, el <b>ePARmed-X</b> ofrece un enfoque más <b>detallado y comprensivo</b>, requiriendo la <b>interpretación y el juicio clínico</b> de un profesional.</p>\r\n" + //
                        "\r\n" + //
                        "<p>El proceso implica que el <b>profesional de la salud</b> guíe al paciente a través del cuestionario, o que lo complete basándose en la información proporcionada por el paciente durante la consulta. Esto permite al profesional considerar de manera integral el <b>estado de salud del paciente</b>, incluyendo <b>condiciones médicas preexistentes, medicaciones, historial clínico</b> y otros <b>factores de riesgo</b> que podrían influir en la <b>seguridad y eficacia de la actividad física recomendada</b>.</p>\r\n" + //
                        "\r\n" + //
                        "<p>La necesidad de que un <b>profesional de la salud</b> esté involucrado en el uso del <b>ePARmed-X</b> subraya la importancia de una <b>evaluación médica precisa y personalizada</b>, asegurando que las <b>recomendaciones de actividad física</b> sean adecuadas para la situación específica de cada individuo y que se tomen en cuenta todas las <b>precauciones necesarias</b> para prevenir riesgos para la salud.</p>\r\n" + //
                        "";
