...
public class ParqService {
    ...
    public QuestionnairesInfo getParqSessionsInfo(Integer id) {
        ...
        String description = "<p>El <b>Cuestionario de Preparación para la Actividad Física</b>, más conocido por sus siglas en inglés <b>PAR-Q+</b> (<i>Physical Activity Readiness Questionnaire for Everyone</i>), es una <b>herramienta ampliamente reconocida y utilizada</b> para la <b>evaluación preliminar del riesgo</b> asociado a la participación en actividades físicas o programas de ejercicio.</p>\r\n" + //
                        "\r\n" + //
                        "<p>Consiste en un <b>cuestionario autoadministrado</b> que incluye preguntas sobre la <b>historia médica</b>, <b>síntomas de enfermedades cardiovasculares, metabólicas y renales</b>, así como otros aspectos de la salud que podrían influir en la <b>seguridad al realizar ejercicio físico</b>.</p>\r\n" + //
                        "\r\n" + //
                        "<p>El objetivo principal del <b>PAR-Q+</b> es identificar a aquellas personas para las cuales un aumento en su actividad física podría representar un <b>riesgo para su salud</b>, sugiriendo la necesidad de una <b>evaluación adicional</b> por parte de un <b>profesional de la salud</b> antes de comenzar un programa de ejercicio.</p>\r\n" + //
                        "\r\n" + //
                        "<p>Además, contribuye a la <b>personalización del ejercicio</b>, adaptando las actividades a las <b>necesidades y condiciones de salud</b> de cada individuo, lo cual es fundamental en el contexto de la <b>fisioterapia</b> y el <b>ejercicio terapéutico</b> para <b>enfermedades crónicas</b> y <b>poblaciones especiales</b>.</p>\r\n" + //
                        "";
